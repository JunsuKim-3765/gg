class Form {
  ...
  display(){
    ...
    this.singlePlayer.mousePressed(()=>{
        ...
        this.cccOk.position(width/3+300,height/2+250)
        this.cccOk.class('customButton');
        ...
        this.cccOk.mousePressed(()=>{
            ...
            this.sP3.position(width/3+1000,height/3+250);
            ...
            this.player3.position(width/2+500,height/3-50); 
            ...
            this.input1.position(width/2-70,height/2+140);
      
            this.start1.class('customButton1')
            this.start1.position(width/2,height/2+250);
            ...
            this.start1.mousePressed(()=>{
              ...
              this.biomeOk.class('customButton');
